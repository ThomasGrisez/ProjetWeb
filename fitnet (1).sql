...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 22 mars 2021 à 23:03
...
INSERT INTO `items` (`id`, `name`, `description`, `price`, `category`, `photo1`, `photo2`, `photo3`, `video`, `quantity`, `type_of_selling`) VALUES
(9, 'Short', 'Short de sport, parfait pour la course Ã  pieds', 35, 'clothe', '2-Short-1.jpg', '', '', '', 1, 'buyitnow'),
(8, 'Banc de musculation', 'Banc professionnel adaptÃ©e aux salles de sport ', 250, 'equipment', '2-Banc_de_musculation-1.jpg', '', '', '', 1, 'buyitnow'),
(7, 'Halteres 10kg', 'Halteres de musculations', 50, 'equipment', '2-Halteres_10kg-1.jpg', '', '', '', 1, 'buyitnow'),
(10, 'Mass Gainer', 'Optimum Nutrition, Top qualitÃ©', 30, 'complement', '2-Mass_Gainer-1.jpg', '', '', '', 1, 'buyitnow'),
(11, 'ABwheel', 'excellent pour les abdos', 20, 'equipment', '2-ABwheel-1.jpg', '', '', '', 1, 'buyitnow');
...
(1, 'gautier', 'thibault', 'thibault.gautier@edu.ece.fr', '1234', '1.jpg', ''),
