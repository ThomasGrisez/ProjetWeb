...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 25 mars 2021 à 22:46
...
(12, 2, 1, 30, 'shoppingcart', 10, 1),
(11, 2, 1, 250, 'shoppingcart', 8, 1);
...
(9, 'Short', 'Short de sport, parfait pour la course Ã  pieds', 35, 'clothe', '2-Short-1.jpg', '', '', '', 1, 'buyitnow', 2),
(8, 'Banc de musculation', 'Banc professionnel adaptÃ©e aux salles de sport ', 250, 'equipment', '2-Banc_de_musculation-1.jpg', '', '', '', 1, 'buyitnow', 2),
(7, 'Halteres 10kg', 'Halteres de musculations', 50, 'equipment', '2-Halteres_10kg-1.jpg', '', '', '', 1, 'buyitnow', 2),
(10, 'Mass Gainer', 'Optimum Nutrition, Top qualitÃ©', 30, 'complement', '2-Mass_Gainer-1.jpg', '', '', '', 1, 'buyitnow', 2),
(11, 'ABwheel', 'excellent pour les abdos', 20, 'equipment', '2-ABwheel-1.jpg', '', '', '', 1, 'buyitnow', 2),
...
(2, 'Grisez', 'Thomas', 'thomas.grisez@edu.ece.fr', '1234', 'ID=2_605ce6f1b15a11.72832734.jpg', '');
COMMIT;
